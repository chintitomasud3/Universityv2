    ...
    public class CoursesController : Controller
    {
        ...
        public IActionResult Create()
        {
           // ViewData["DepartmentID"] = new SelectList(_context.Departments, "DepartmentID", "DepartmentID");
            ViewBag.Dropdown = new SelectList(_context.Departments, "DepartmentID", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CourseID,Title,Credits,DepartmentID,Semester,Year")] Course course)
        {
