...
namespace MasudUniversity.Controllers
{
    public class CourseAssignmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InstructorID,CourseID")] CourseAssignment courseAssignment)
        {
            ...
            ViewBag.CourseName = new SelectList(_context.Courses.Include(s=>s.CourseID), "CourseID", "Title", courseAssignment.Course.CourseID);
            ViewData["InstructorID"] = new SelectList(_context.Instructors, "ID", "Name", courseAssignment.InstructorID);
